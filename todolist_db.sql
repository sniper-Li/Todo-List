...
--
-- Host: 9.236.36.31    Database: todolist_db
-- ------------------------------------------------------
...
CREATE TABLE `reminders` (
  ...
  PRIMARY KEY (`id`),
  KEY `todo_id` (`todo_id`),
  CONSTRAINT `reminders_ibfk_1` FOREIGN KEY (`todo_id`) REFERENCES `todos` (`id`)
...
-- Dump completed on 2023-09-08 17:32:22
-- ************************************************************
--
-- close fk
--
...
-- Dump completed on 2023-09-08 17:32:23
